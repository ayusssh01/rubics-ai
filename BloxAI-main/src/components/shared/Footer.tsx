      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between gap-8">
          <div className="mb-6 md:mb-0 flex-1">
            <a href="https://rubics-ai.vercel.app/" className="flex items-center">
              <Image
                width={500}
                height={500}
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="text-muted-foreground font-medium">
                ...
                <li className="mb-4">
                  <a
                    href="https://www.linkedin.com/in/priya998/"
                    className="hover:underline"
                  >
                    Priya Kumari
                  </a>
        ...
        <div className="flex justify-between items-center">
          <span className="text-sm text-gray-500 sm:text-center dark:text-neutral-500">
            © 2025{" "}
            <a href="https://rubics-ai.vercel.app/" className="hover:underline">
              RubicsAI
            </a>
            . All Rights Reserved.
          </span>
